...
public class client {
    ...
    public client() {
        ...
        */
        ...
        networkListener();
        consoleListener();
        System.out.println("Wating for lobby to be full");
        System.out.println("[Client] Exiting Main Thread...");
    }
    ...
    public void placeShip(int size, int x, int y, String direction) {
        ...
        if (!gamestate.equals("preparation")) {
            ...
            System.out.println("[Game] Du hast bereits alle Schiffe der Größe plaziert!");
            return;
        }

        System.out.println("[Game] Plaziere neues Schiff. Größe:" + size + " X:" + x + " Y:" + y + " Richtung: " + direction);
    ...
    public void prepTest() {
        ...
        if (prepfinished) {
            sentUTF("ready");
            System.out.println("[Game] Alle Schiffe plaziert. Warte auf Spielstart...");
    ...
    public void printTargetField() {
        System.out.println("[Game] Gegenerfeld: ");
    ...
    public void networkListener() {
        ...
        threadNetworkListener = new Thread(() -> {
            ...
            System.out.println("[NetworkListener] thread died");
        });
